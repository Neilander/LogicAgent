"""H2: food + threat 识别核 + safe_path 规划核。"""
...
from stages.h3_water_threat.executor import execute
from stages.h3_water_threat.graph import build_graph, graph_to_text
from stages.h3_water_threat.planner import greedy_nearest
