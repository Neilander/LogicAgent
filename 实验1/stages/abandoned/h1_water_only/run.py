"""Stage 1 (water) 入口：跑一个 Crafter episode，记录指标和决策 trace。

差别 vs Stage 0：
  - 同时调 food + water 两个识别核
  - 用 need_based_nearest 规划核（按 food/drink 缺口选目标）
"""
...
from stages.stage1_water.executor import execute
from stages.stage1_water.graph import build_graph, graph_to_text
from stages.stage1_water.planner import greedy_nearest
